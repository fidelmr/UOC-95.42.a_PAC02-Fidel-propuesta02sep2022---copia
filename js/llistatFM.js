...
async function llistat_configuracioURLSenseParametres(){
    ...
    */
    ...
    for(let x=0; x<10; x++){
        ...
        // ******************************************
        // ******************************************
        linia08a   = `      <a href="llistatFM.html?pokeID=${poke_id}" class="poke_btnDetalls">VEURE MES DETALLS</a>`
        // ******************************************
        // ******************************************
        linia09    = '</article>'
    ...
    for(let x=0; x<targetesmax; x++){
        targetes[x].addEventListener("click",function(){
            ...
            */
            ...
            let urlPokeID1 = "llistatFM.html?pokeID=" + pokeID1
...
async function llistat_configuracioURLAmbParametres(){
    ...
    */
    ...
    linia11    = ""
    linia11    = '      <a href="llistatFM.html">RETORNAR AL LLISTAT</a>'
